...
CREATE TABLE PowerStats (
  ...
  primary KEY (powerStat_ID, hero_ID)
);
...
ALTER TABLE CanDo
  ADD CONSTRAINT Ability_fk FOREIGN KEY (ability_ID) REFERENCES Ability (ability_id) ON DELETE CASCADE;
  ALTER TABLE CanDo
  ADD CONSTRAINT HeroDo_fk FOREIGN KEY (Hero_ID) REFERENCES Hero (hero_id);


ALTER TABLE FightResult
  ADD CONSTRAINT Loser_fk FOREIGN KEY (Loser) REFERENCES Hero (hero_id) ON DELETE CASCADE ON UPDATE CASCADE;
  ALTER TABLE FightResult
  ADD CONSTRAINT fight_id_fk FOREIGN KEY (schedule_ID,Location) REFERENCES FightSchedule (schedule_id, location) ON DELETE CASCADE ON UPDATE CASCADE;
  ALTER TABLE FightResult
  ADD CONSTRAINT schedulefk FOREIGN KEY (schedule_ID) REFERENCES Sche (schedule_id) ON DELETE CASCADE ON UPDATE CASCADE;
  ALTER TABLE FightResult
  ADD CONSTRAINT winner_fk FOREIGN KEY (Winner) REFERENCES Hero (hero_id) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER TABLE FightSchedule
  ADD CONSTRAINT schedule_fks FOREIGN KEY (Schedule_ID) REFERENCES Sche (schedule_id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE HasEarnedMedal
  ADD CONSTRAINT EarnedMedal_Hero_fk FOREIGN KEY (Hero_ID) REFERENCES Hero (hero_id) ON DELETE CASCADE ON UPDATE CASCADE;
  ALTER TABLE HasEarnedMedal
  ADD CONSTRAINT EarnedMedal_Medal_fk FOREIGN KEY (medal_ID) REFERENCES MedalHonors (medal_id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE Hero
  ADD CONSTRAINT Aff_FK FOREIGN KEY (affiliation) REFERENCES AffiliTAB (aff_id) ON DELETE CASCADE ON UPDATE CASCADE;
  ALTER TABLE Hero
  ADD CONSTRAINT Hrank_fk FOREIGN KEY (heroRank_ID) REFERENCES HeroRank (herorank_id) ON DELETE CASCADE ON UPDATE CASCADE;
  ALTER TABLE Hero
  ADD CONSTRAINT PowerStat_fk FOREIGN KEY (powerStat_ID) REFERENCES PowerStats (powerstatsid) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER TABLE HeroDobAge
  ADD CONSTRAINT HeroDobAge_fk FOREIGN KEY (DOB) REFERENCES Hero (dob) ON DELETE CASCADE;

ALTER TABLE HeroRank
  ADD CONSTRAINT HeroRank_fk FOREIGN KEY (Hero_ID) REFERENCES Hero (hero_id) ON DELETE CASCADE;

ALTER TABLE Hero_schedule
  ADD CONSTRAINT Hero_fk FOREIGN KEY (Hero_ID) REFERENCES Hero (hero_id) ON DELETE CASCADE ON UPDATE CASCADE;
  ALTER TABLE Hero_schedule
  ADD CONSTRAINT Sche_FK FOREIGN KEY (Schedule_ID) REFERENCES Sche (schedule_id) ON DELETE CASCADE ON UPDATE CASCADE;


ALTER TABLE PowerStats
  ADD CONSTRAINT PowerStats_fk FOREIGN KEY (Hero_ID) REFERENCES Hero (hero_id) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE users
  ADD CONSTRAINT users_fk FOREIGN KEY (Hero_ID) REFERENCES Hero (hero_id) ON DELETE SET NULL;
